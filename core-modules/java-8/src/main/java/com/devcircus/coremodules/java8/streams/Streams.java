package com.devcircus.coremodules.java8.streams;
...
import com.devcircus.coremodules.java8.common.modelo.Cliente;
import com.devcircus.coremodules.java8.common.modelo.Factura;
import com.devcircus.coremodules.java8.common.modelo.FacturaDTO;
...
public class Streams {
    ...
    public static void main(String[] args) {
        ...
        // Recorriendo una coleccion old school style
        // =====================================================================
        System.out.println("====================================================");
        ...
        // Java 8: nuevo metodo en la interfaz collection para recorrer colecciones:
        ...
        // Cada vez que invoquemos 'it.next()' un nuevo elemento saldra del stream
        while (it.hasNext()) {
            System.out.println(it.next());
        }

        // allMatch:combrueba si todos los elementos cumplen un predicado
        // anyMatch:comprueba si algun elemento cumple un predicado
        // =====================================================================
        ...
        // Maaximo/minimo con un comparador        
        // =====================================================================
        ...
        // Con una lambda
        // Lo mismo con una expresion Lambda
        // =====================================================================
        ...
        System.out.println("Media de los numeros:" + media2);
        ...
        // reduce : obtiene un objeto de la coleccion incial
    }
